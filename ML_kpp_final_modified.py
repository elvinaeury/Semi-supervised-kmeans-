...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 16 19:28:54 2020
...
def kpp_init(k,X):
    ...
    for c in range(1,k):
        ...
        """ Fixer le candidat corespondanr à candidate_ids[0] comme le meilleur candidat et le comparer aux autres candidats pour modification si nécessaire """
